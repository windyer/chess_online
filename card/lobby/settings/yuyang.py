...
YUYANG = DotDict({
    "app_key": "d4917540f464dcd7569f1a8257b34eef",
   ...
   #'login_url': "http://sdk.api.gamex.mobile.youku.com/game/user/infomation",
    'query_order_url': "http://game.51yund.com/index.php?m=Index&a=checkorder",
    'app_id':"1048",
    "channel": "zx018",
    "notify_url":"http://120.27.103.99/three/yuyang/charge-notify/",
    'need_validate_form':True,
    'need_auth': True,
    'yuyang_items':DotDict({
